...
public class PinchImageView2 extends ImageView implements OnTouchListener  {
    ...
    public PinchImageView2(Context context,AttributeSet attr) {
        super(context,attr);
        _init();
    }

    public PinchImageView2(Context context) {
        super(context);
        _init();
    }

    public PinchImageView2(ImageView im) {
        super(im.getContext());
        _init();
        this.im = im;
